    ...
    1: function (e, t, i) {
        ...
        var a = function () {
            ...
            return t = e, (i = [{
                ...
                key: "toNumber", value: function (e) {
                    return !!this.isNumber(e) && +e
                }
            }, {
                key: "isDOMEl", value: function (e) {
        ...
        var o = s.a, l = n.a, u = function () {
            ...
            return t = e, (i = [{
                ...
                key: "setAValueTo", value: function (e, t, i) {
                ...
                key: "setType", value: function (e) {
                    for (var t in this.typeConstants) if (e === this.typeConstants[t]) return this.type = e, this.typeUpdateEvent.trigger({
                        value: this.type,
                        typeConstants: Object.assign({}, this.typeConstants)
                    }), {value: this.type, typeConstants: Object.assign({}, this.typeConstants)}
                }
            }, {
                key: "setLimits", value: function (e, t) {
                    o.isObject(e) || (e = {});
                ...
                key: "setSingleValue", value: function (e, t) {
                ...
                key: "setNearestValue", value: function (e, t, i) {
                    if (o.isNumber(e)) return e = !1 === t ? Math.round(+e) : Math.round(this.valuesCount * +e / 100 + this.minLimit), this.type === this.typeConstants.singleValue ? this.setSingleValue(e, i) : this.type === this.typeConstants.rangeValue ? e < (this.rangeValueMin + this.rangeValueMax) / 2 ? this.setRangeValue({minValue: +e}, !0) : this.setRangeValue({maxValue: +e}, !0) : void 0
                }
            }, {
        ...
        var d = n.a, r = s.a, v = function () {
            ...
            return t = e, (i = [{
                ...
                key: "applyStyles", value: function () {
                    ...
                    [this.base, this.outer, this.path, this.pathPassed, this.divisions, this.handle, this.handleMin, this.handleMax, this.valueNote, this.valueNoteMin, this.valueNoteMax].concat(this.divisionsList).forEach((function (t) {
                        for (var i in e) {
                            var n = t.classList[0], s = e[i].oldValue, a = e[i].value;
                            s && t.classList.remove(n + "_" + e[i].className + "_" + s), t.classList.add(n + "_" + e[i].className + "_" + a)
                        }
                    }))
                }
            }, {
                key: "drawValue", value: function (e, t, i) {
                    var n, s, a = e.selected, o = this.direction.value, l = this.directionConstants, u = i.value,
                        h = i.typeConstants;
                ...
                key: "applyValueNoteDisplay", value: function () {
                    var e = this;
                ...
                key: "generateDivisions", value: function () {
                ...
                key: "setDivisionsCount", value: function (e, t) {
                ...
                key: "setDirection", value: function (e) {
                    if ("string" == typeof e) for (var t in this.directionConstants) if (e === this.directionConstants[t]) return this.direction.oldValue = this.direction.value, this.direction.value = e, this.directionUpdateEvent.trigger({
                ...
                key: "setValueNoteDisplay", value: function (e) {
                ...
                key: "getValueNoteDisplay", value: function () {
                    return this.valueNoteDisplay
                }
            }, {
                key: "getDivisionsCount", value: function () {
                    return this.divisionsCount
                }
            }, {
                key: "_buildBaseDOM", value: function () {
                ...
                key: "_addListenners", value: function () {
                    this.path.addEventListener("mousedown", this._mouseDownActionHandler.bind(this))
                }
            }, {
                key: "_mouseDownActionHandler", value: function (e) {
                    if (0 === e.button) {
                        var t = !1, i = function (e) {
                            var t, i, n, s, a = this.direction.value, o = this.directionConstants;
                        ...
                        document.body.addEventListener("mousemove", (function () {
                            return t = !0
                        }), {once: !0}), document.body.addEventListener("mousemove", i), document.body.addEventListener("mouseup", n, {once: !0})
                    }
                }
        ...
        var c = function () {
            ...
            return t = e, (i = [{
                ...
                key: "_initInstance", value: function () {
                ...
                key: "_applyUserEvents", value: function (e) {
                ...
                key: "_applyUserOptions", value: function (e) {
                ...
                key: "_triggerEvents", value: function () {
        ...
        window.wRunner = function (e) {
            ...
            return function () {
                var i = new t.Model, n = new t.View, s = new t.Presenter({model: i, view: n, userOptions: e}), a = {
